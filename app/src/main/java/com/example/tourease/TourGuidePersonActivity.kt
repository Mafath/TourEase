...
class TourGuidePersonActivity : AppCompatActivity(){

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_tourguide_person)

        val backBtn: View = findViewById(R.id.btn_back)
        val fromDate: View = findViewById(R.id.from_date)
        val toDate: View = findViewById(R.id.to_date)
        val book: View = findViewById(R.id.btn_book_now)
        ...
        bottom.setOnItemSelectedListener { item ->
            when (item.itemId) {
                ...
                R.id.nav_grid -> { // Quick Bookings
                    if (this !is QuickBookingsActivity) {
