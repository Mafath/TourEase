...
class QuickBookingsActivity : AppCompatActivity(){

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_quick_bookings)


        val backBtn: View = findViewById(R.id.btn_back)
        val hotel: View = findViewById(R.id.circle_hotel)
        val guide: View = findViewById(R.id.circle_guides)
        val plan: View = findViewById(R.id.circle_rent)
        ...
        hotel.setOnClickListener {
            startActivity(Intent(this, HotelRoomActivity::class.java))
            finish() //prevent returning to this screen
        }

        guide.setOnClickListener {
            startActivity(Intent(this, TourGuideActivity::class.java))
            finish() //prevent returning to this screen
        }
